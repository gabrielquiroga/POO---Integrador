...
${OBJECTDIR}/Conjunto.o: Conjunto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conjunto.o Conjunto.cpp

${OBJECTDIR}/baserobot.o: baserobot.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/baserobot.o baserobot.cpp

${OBJECTDIR}/efector_final.o: efector_final.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/efector_final.o efector_final.cpp
